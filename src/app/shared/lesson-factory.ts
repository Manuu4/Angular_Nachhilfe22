...
export class LessonFactory {
  static empty() : Lesson {
     return new Lesson("99", "Beste Einheite ever", "Fu** yeah! This lesson kicks a**!", "", "vergeben", new User("7",'Vanny', 'Maith', 'KWM', true, 'vanny@gmail.com'), new Course("5",'FachrichtungABC', 'Alles dzu dem Themaecececece', "3"), new Date('2022,6,28'));
